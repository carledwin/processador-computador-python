...
class Computador:
    def __init__(self, nome: str, codigo: str, produto: str, versao: dict = None,
...
def processar(arquivo_json: str):
    ...
    nome_xls = os.path.splitext(arquivo_json)[0] + '_processado.xlsx'
    df_computadores.to_excel(nome_xls, index=False, engine='openpyxl')
    print(f"Arquivo '{nome_xls}' salvo com sucesso!")
